...
router.put ('/editComment/:commentId',verifyToken, editComment); //sometimes we want to update
router.get('/getComments',verifyToken, getComments); //sometimes we want to update

router.delete('/deleteComment/:commentId',verifyToken, deleteComment); //sometimes we want to update
